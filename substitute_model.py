...
# Model
def createNN_1layer(filters, kernel_size, strides, padding, output_dim, activation, loss, weights, bias, learning_rate):
...
def prep_bbox(sess, x, y, x_train, y_train, x_test, y_test,
  ...
  #model = createNN_1layer(filters=64, kernel_size = (5, 5), strides=(1,1), padding='valid', output_dim=10, activation='relu', loss='categorical_crossentropy', weights='random_normal', bias='zeros', learning_rate = 0.001)
...
def main(argv=None):
  ...
  substitute_model = mnist_blackbox(nb_classes=FLAGS.nb_classes, batch_size=FLAGS.batch_size,
